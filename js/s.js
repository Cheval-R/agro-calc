...
let removal = [
	...
	{
		name: "Свёкла сахарная",
		nitrogen: 0.59,
		phosphorus: 0.18,
		potassium: 0.75
	},
	{
		name: "Кормовая свекла",
		nitrogen: 0.49,
		phosphorus: 0.15,
		potassium: 0.67
	},
	...
	{
		name: "Кормовая морковь",
		nitrogen: 0.52,
		phosphorus: 0.19,
		potassium: 0.6
	},
	{
		name: "Столовая свекла",
		nitrogen: 0.32,
		phosphorus: 0.16,
		potassium: 0.5
	},
	...
	{
		name: "Подсолнечник з/м",
		nitrogen: 0.3,
		phosphorus: 0.1,
		potassium: 0.45
	},
	{
		name: "Горох с овсом з/м",
		nitrogen: 0.3,
		phosphorus: 0.14,
		potassium: 0.5
	},
	{
		name: "Вика с овсом з/м",
		nitrogen: 0.3,
		phosphorus: 0.12,
		potassium: 0.45
	},
	{
		name: "Рожь озимая з/м",
		nitrogen: 0.3,
		phosphorus: 0.12,
		potassium: 0.45
	},
...
btn.on('click', () => {
	...
	$('.row').each(function (index) {
		...
		// !Азотное удобрение
		console.log($(this).find('.fertilizer-nitrogen-cell select option:selected').text());
		const fertilizerNameN = $(this).find('.fertilizer-nitrogen-cell select option:selected').text();
		// !Фосфорное удобрение
		console.log($(this).find('.fertilizer-phosphorus-cell select option:selected').text());
		const fertilizerNameP = $(this).find('.fertilizer-phosphorus-cell select option:selected').text();
		// !Калийное удобрение
		console.log($(this).find('.fertilizer-potassium-cell select option:selected').text());
		const fertilizerNameK = $(this).find('.fertilizer-potassium-cell select option:selected').text();
